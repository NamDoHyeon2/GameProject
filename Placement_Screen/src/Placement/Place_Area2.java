...
public class Place_Area2 extends JPanel {
	...
	public Place_Area2(int location_num) {
		...
		this.select_place_panel = new ImagePanel(new ImageIcon("C:\\Project\\GameProject-DB_feature\\Image\\src\\Image\\location3.png").getImage());
		...
		this.no_select_place_panel = new ImagePanel(new ImageIcon("C:\\Project\\GameProject-DB_feature\\Image\\src\\Image\\location2.png").getImage());
